...
# left/right from the HOSTNAME and APPENDS GRIPPER_HAND to /etc/gripette/env.
...
HAND_HOSTNAME_PREFIX = "gripette"
HAND_ENV_FILE = "/etc/gripette/env"
HAND_ENV_VAR = "GRIPPER_HAND"
HAND_UNIT = "gripette.service"
