"""Bluetooth LE WiFi configuration service for Casquette.
...
- Device name: "Casquette"
- PIN: from env var CASQUETTE_BT_PIN (not dfu-util serial)
...
class BluetoothWifiService:
    ...
    def __init__(self, device_name: str = "Casquette", pin_code: str = "00000"):
