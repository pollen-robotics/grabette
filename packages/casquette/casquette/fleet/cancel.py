# Copied from grabette/cancel.py (develop @0cb3453) for the casquette fleet
# prototype. Deviation: logger name only. Keep in sync until extracted to a
# shared package. See casquette/fleet/__init__.py.
...
logger = logging.getLogger("casquette.cancel")
