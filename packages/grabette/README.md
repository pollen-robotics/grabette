...
2. Switch to a network it already knows, in one click and with no password
3. Add a new network via the Bluetooth tool — the way in when the device is on no network you can reach
