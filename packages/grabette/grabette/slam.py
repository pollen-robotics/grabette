                ...
                async with httpx.AsyncClient(timeout=30, headers=_headers) as http:
                    r = await http.post(
                        ...
                        json={
                            ...
                            "exclude_bad_speed": exclude_bad_speed,
                            "exclude_bad_drift": exclude_bad_drift,
                            "exclude_bad_zigzag": exclude_bad_zigzag,
                            "exclude_warn_jumps": exclude_warn_jumps,
                            "exclude_warn_tracking": exclude_warn_tracking,
